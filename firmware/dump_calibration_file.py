...
print('Everything marked with * seem to be planned at some point, but is not actually used by the v9 firmware.')
...
printCal_mul(0x59e,1.0,'0x59E*', -1)
printCal_mul(0x5a6,1.0,'0x5A6*', -1)
printCal_mul(0x5ae,1.0,'0x5AE*', -1)
